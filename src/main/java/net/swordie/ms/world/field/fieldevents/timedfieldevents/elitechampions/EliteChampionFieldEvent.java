...
public abstract class EliteChampionFieldEvent extends TimedFieldEvent {
    ...
    private static final int MINIMUM_DMG_RATIO_FOR_REWARD = ServerConfig.ELITE_CHAMPION_MIN_DMG_RATIO_FOR_REWARD;

    private static final int ELITE_CHAMPION_ORB_COUNT = 4;
    private static final int ELITE_CHAMPION_ORB_EXP_MULTIPLIER = ServerConfig.ELITE_CHAMPION_ORB_EXP_MULTIPLIER;
